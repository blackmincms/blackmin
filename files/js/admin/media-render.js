...
*	#file: 2.0
*
*	this file is render medioa in table | admin panel
*/
                    ...
                    out += ( `
                        ...
                        <thead class="tsr-width-100 fs-120 tsr-border-bottom-solid-black-1">
                            <tr>
                                ...
                                <td class="tsr-width-150px tsr-width-100-2 tsr-display-block-2 tsr-p-5px tsr-algin-left-2" bm-data="bm-author">
                                    Autor
                                </td>
                                <td class="tsr-width-30 tsr-width-100-3 tsr-display-block-3 tsr-p-5px tsr-algin-left-2" bm-data="bm-description">
                                    Opis
                                </td>
                                <td class="tsr-width-100px tsr-width-100-3 tsr-display-block-3 tsr-p-5px tsr-algin-left-2" bm-data="bm-folder">
                                    Folder
                                </td>
                                <td class="tsr-width-100px tsr-width-100-3 tsr-display-block-3 tsr-p-5px tsr-algin-left-2" bm-data="bm-file-type">
                                    Rozszerzenie
                                </td>
                                <td class="tsr-width-100px tsr-width-100-3 tsr-display-block-3 tsr-p-5px tsr-algin-left-2" bm-data="bm-datetime">
                                    Data Opublikowania
                                </td>
                            </tr>
                        </thead>
                    ...
                    for (i=0; i < t["num_rows"]; i++) {
                        ...
                        out += ( `
                            <tr class="tsr-color-table bm-row-dl" bm-row-data="${i}">
                                ...
                                <td class="tsr-display-block-2 tsr-p-5px tsr-word-break tsr-algin-left-2" bm-data="bm-author"> ${t[i]["autor"]} </td>
                                <td class="tsr-display-block-3 tsr-p-5px tsr-word-break tsr-algin-left-2" bm-data="bm-description"> ${opis} </td>
                                <td class="tsr-display-block-3 tsr-p-5px tsr-word-break tsr-algin-left-2" bm-data="bm-folder"> ${t[i]["bm_folder"]} </td>
                                <td class="tsr-display-block-3 tsr-p-5px tsr-word-break tsr-algin-left-2" bm-data="bm-file-type"> ${t[i]["bm_file_type"]} </td>
                                <td class="tsr-display-block-3 tsr-p-5px tsr-word-break tsr-algin-left-2" bm-data="bm-category"> ${data} </td>
                            </tr>
                        `);
                    }
