...
*/
	...
	function get_plugin_bm(){
		...
		$bm_widget["logowanie"] = '
			<section class="tsr fs-100 tsr-p-10px bm-logowanie"><a href="'.url_serwer_bm().'bm/logowanie.php">Logowanie</a></section>
		';
		...
		$bm_widget["wyszukiwarka"] = '
				<form accept-charset="UTF-8" action="" method="get" autocomplete="off" class="tsr-p-10px search_form_bm">	
					<section class="tsr tsr-position-relative">
						...
						<input type="image" name="search" class="tsr-width-50px input tsr-icons-right tsr-icons-box-right col-st10" src="'.url_server_bm().'pliki/ikony/szukaj.png" >
					</section>
				</form>		
		';
