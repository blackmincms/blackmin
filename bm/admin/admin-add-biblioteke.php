...
/*
	...
	ten plik służy renderowania strony odpowiedzialnej za dodawanie nowych bibliotek
...
<head>
	...
	<title>Dodaj Bibliotekę - Admin Panel - <?php echo $black_min ?></title>
		...
		<section class="container tsr-p-10px">
			...
			<section class="tsr tsr-p-10px background-white tsr-mt-20">
				...
				<section class="tsr tsr-mt-20">
					...
					<section class="tsr">
						...
						<section class="col-inp-75 tsr-p-10px fs-90" >
							<input type="text" name="nazwa_biblioteka" class="input" placeholder="Black Min" autocomplete="off"/>
						</section>
					</section>	

					<section class="tsr tsr-inp tsr-mt-50">
					<button type="submit" class="input buttom" id="submit_post" >Dodaj Bibliotekę</button>
					</section>	
				...
				<script type="text/javascript">			
					...
					evt1.preventDefault();
					var nazwa_biblioteka = $('input[name="nazwa_biblioteka"]').val();
					var edt_biblioteka = "home";
					$.ajax({
						type:"POST",
						url:"insert/add-biblioteka.php",
						data:{
							nazwa_biblioteka:nazwa_biblioteka,
							edt_biblioteka:edt_biblioteka,
						}
					})
					.done(function(info){
