...
/*
	...
	ten plik służy renderowania strony odpowiedzialnej za dodawanie nowych skryptów
...
<head>
	...
	<title>Dodaj Skrypt - Admin Panel - <?php echo $black_min ?></title>
...
<body>
				...
				<section class="tsr tsr-mt-20">
					...
					<section class="tsr">
						...
						<section class="col-inp-75 tsr-p-10px fs-90" >
							<input type="text" name="nazwa_skryptu" class="input" placeholder="Black Min" autocomplete="off"/>
						</section>
					</section>	

					<section class="tsr tsr-inp tsr-mt-50">
					<button type="submit" class="input buttom" id="submit_post" >Dodaj Skrypt</button>
					</section>	
	...
	<script type="text/javascript">			
		...
		evt1.preventDefault();
		var nazwa_skryptu = $('input[name="nazwa_skryptu"]').val();
		var edt_plugin = "home";
		$.ajax({
			type:"POST",
			url:"insert/add-skrypt.php",
			data:{
				nazwa_skryptu:nazwa_skryptu,
