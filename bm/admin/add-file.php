...
*	#file: 2.0
*
*	This file is add file | admin panel
*/
	...
	$SFL->add_js(BM_SETTINGS["url_server"] . "files/js/admin/file-system-db.js");
...
?>	
	...
	<section class="tsr tsr-p-10px background-white tsr-mt-20">
		<section class="tsr" id="blackminload_execute_container">			
			...
			<form action="media" class="tsr-upload" id="tsr_upload" method="FILE" enctype="multipart/form-data" style="min-height: 450px;">		
			...
			<script>
				$(document).ready(function(){
					tsr_upload('bm/core/Delegate/DelegateBM.php', ".tsr-upload", ".tsr-upload-container", ".tsr-upload-box", "*", true, function(a){
						console.log(a);
					}, 5000000);
				});	
			</script>	
