		...
		<nav class="tsr-nav-menu tsr-p-5px tsr-nav-menu tsr-position-fixed tsr-menu-background">
			<section class="col-ms90 tsr-menu-hiden">
				<section class="col-ms20 tsr-height-100 tsr-height-50px">
					<section class="img logo tsr-height-webkit-fill-available" style="background-image: url(<?php echo url_server_bm();?>pliki/logo/logo_bm_cale_black_2_100_600.png);"></section>
				</section>
				<section class="col-ms80 ">
					<ol class="menu">
						<li><a href="<?php echo url_site_bm();?>"><?php echo $bm_nazwa_strony_bm_skrucona; ?></a></li>
						</li>
			...
			<div class="tsr tsr-display-none tsr-display-block-3 tsr-width-50-3 tsr-width-50px-2 tsr-height-40px tsr-float-right tsr-ma">
				<img src="<?php echo url_server_bm();?>pliki/logo/logo_bm_black_2_100_100.png" alt="logo" class="tsr">
			</div>
