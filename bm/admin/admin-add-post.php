						...
						<section class="col-inp-50">
							...
							<section class="col-inp-50 tsr-p-10px fs-90" >
								<select name="kategoria" id="kategoria">
									...
									<!--<option value="1" onClick"showzwd()">zawody</option>-->
								</select>
							</section>
						</section>
								...
								<section class="aquay-nawigacja background-szary">	
									...
									<section class="aquay-sekcjia">
										...
										<section class="aquay-ikona wysrodkuj_do_lewej" onclick="aquay_edytor('justifyLeft');">
											<img src="<?php echo $url_serwera_bm; ?>files/global/timonix-aquay-edytor/ikony/justify/justifyleft-big.png" alt="wyśrodkuj do lewej" title="wyśrodkuj do lewej">
										</section>
										<section class="aquay-ikona wysrodkuj" onclick="aquay_edytor('justifyCenter');">
											<img src="<?php echo $url_serwera_bm; ?>files/global/timonix-aquay-edytor/ikony/justify/justifycenter-big.png" alt="wyśrodkuj" title="wyśrodkuj">
										</section>
