...
class Router
{
    ...
    public function get_url_bm() {
        ...
        $url_witryny_bm = $this->settings["url_site"];
    ...
    public function reltoabs($inurl, $absolute) {
        self::relativeToAbsolute($inurl, $absolute);
    }
    ...
    public function check_url(){
        ...
        if($this->settings["bm_maintenance_mode"] == "true"){
            $t = "maintenance_mode";
    ...
    public function bm_url(){
        ...
        if (strstr(self::get_orginal_url_bm(), $this->settings["url_site"]) === false) {
            // przekierowanie do strony głownej
            header("Location:". $this->settings["url_site"]);
            exit();
        }
        ...
        if($c == "root"){
            ...
            $t["path"] = $this->settings["url_site"];
            $t["checked_url"] = "$c";
            $t["url_parse"] = ["". $this->settings["url_site"] .""];
            $t["url_full"] = $this->settings["url_site"];
            ...
            header("Location:".$this->settings["url_server"]. "bm/admin/admin-panel.php");
            exit();
        }elseif($c == "post_page"){
            $t["path"] = $s[$z-1];
            $t["checked_url"] = "$c";
